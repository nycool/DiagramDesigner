...
namespace DiagramDesigner.BaseClass.DesignerItemViewModel
{
    public abstract class GroupDesignerItemViewModelBase : DesignerItemViewModelBase, IDiagramViewModel
    {
        ...
        protected GroupDesignerItemViewModelBase(Guid id, IDiagramViewModel parent, double left, double top)
        ...
        protected GroupDesignerItemViewModelBase(Guid id, IDiagramViewModel parent, double left, double top, double itemWidth, double itemHeight)
