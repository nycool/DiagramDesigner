...
namespace DiagramDesigner.Custom
{
    ...
    public class PreViewBox : Control
    {
        static PreViewBox()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PreViewBox), new FrameworkPropertyMetadata(typeof(PreViewBox)));
        }
        ...
        public static readonly DependencyProperty ScrollViewerProperty =
            DependencyProperty.Register("ScrollViewer", typeof(ScrollViewer), typeof(PreViewBox));
